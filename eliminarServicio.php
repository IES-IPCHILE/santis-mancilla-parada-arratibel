...
$query = "SELECT id FROM servicio where servicio.id= $id";
...
if (mysqli_num_rows($res) > 0) {
  ...
  while ($row = mysqli_fetch_assoc($res)) {
                  ...
                  echo "<div class='container'>
                        <div class='jumbotron'>
                        <form action='./resources/QuerysServicio.php' method='POST'>
                        <h2>Eliminar Servicio:</h2>

                        <div class='form-group row'>
                        <label class='col-lg-6 col-form-label'>¿Segur@ desea Eliminar el servicio con ID:  ". $_POST['EliminarServicio']." ?</label>

                        <div class='col-lg-12' style='text-align: center;'>
                        <label class='col-lg-12 col-form-label'></label>
                        <button type='submit' class='btn btn-success' name='EliminarServicio' value='". $_POST['EliminarServicio'] ."'>Sí</button>
                        <button type='submit' class='btn btn-danger' name='VolverServicio'>No</button>
                        </div>
